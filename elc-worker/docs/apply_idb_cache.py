...
(function installElcRtdbCache() {
  ...
  // v3: после sparse-fix для users/companies/pipelines (PR #42) — старые v2 записи
  //     users.json (~3KB) содержали выкинутые null поля → renderDeals падал на
  //     `localeCompare(undefined)`. Bump форсирует fresh fetch.
