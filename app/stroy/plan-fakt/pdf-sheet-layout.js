...
(function(){
'use strict';
let choosing=false,dragRect=null,cropDraft=null,drawingEdit=false,regionCallback=null;
...
for(const name of ['goPage','closeStandalonePdf']){const old=window[name];window[name]=function(...args){regionCallback=null;drawingEdit=false;choosing=false;dragRect=null;outline.replaceChildren();dialog.style.display='none';const out=old.apply(this,args);draw();return out;};}
