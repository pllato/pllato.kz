...
$('sheetQuickTable').onclick=()=>{show();$('sheetTable').scrollIntoView({block:'center'});$('sheetTable').focus();};$('sheetQuickStamp').onclick=()=>{show();$('stamp_code').scrollIntoView({block:'center'});$('stamp_code').focus();};
