// Pllato CORE CRM — конфигурация Firebase.
// Используется тот же проект `pllato-crm`, что и в pllato.kz/app.html и team.html —
// единый аккаунт сотрудника даёт доступ ко всем приложениям Pllato.
...
// URL развёрнутого Cloudflare Worker. Пока пусто — фронт работает без API.
