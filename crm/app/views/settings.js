...
import { setEmployeePassword, generateTempPassword, logout, getSession } from "../auth.js";
      ...
      <section class="settings-block">
        ...
        <div class="settings-body">
          ...
          ${!isEmployeesSynced() ? `<div>
            ...
            ${getSession() ? `<button class="btn-ghost" id="logoutBtn" title="Выйти из аккаунта">${ICONS.logout}<span>Выйти из аккаунта</span></button>` : ""}
          </div>` : ""}
        </div>
      </section>
...
function wireEvents(container) {
  ...
  // Кнопка "Сгенерировать пароль" в форме сотрудника
