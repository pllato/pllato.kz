# Текущее состояние · обновлено 2026-08-15
...
- `codex/fix-irina-stale-crm-writes` — устранить тихую потерю примечаний/календарных дат на Meta-лидах и автоматически обновлять долго открытую CRM.
