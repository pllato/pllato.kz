...
- `codex/force-refresh-facebook-lead-editor` — принудительно обновить старые PWA Ирины, которые ещё отправляют правки Facebook-лидов в `deal_null`, и журналировать такие отказы.
