...
- `codex/legacy-meta-write-resolution` — серверная совместимость для старой PWA: восстанавливать точный Meta deal ID для шапки и Zoom вместо отказа `deal_null/deal_`.
