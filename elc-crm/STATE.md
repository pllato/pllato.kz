...
- `fix/elc-almaty-stage-permissions` — разрешить сотрудникам с `dealScope=all` сохранять смену стадии у видимых сделок в доступной воронке (в т.ч. новые лиды без ответственного).
