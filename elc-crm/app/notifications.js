...
export function seedDemoNotifications() {
  ...
  const seed = [
    ...
    { type: "system", title: "Pllato CRM обновлён до v0.2",         description: "Появились центр уведомлений и графики на дашборде.", link: "#dashboard", _ts: now - 6 * 3600000, read: true },
  ];
  seed.forEach(s => {
    const { _ts, ...data } = s;
